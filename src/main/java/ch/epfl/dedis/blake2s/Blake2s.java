...
/**
 * Implementation based on: https://github.com/StableLib/stablelib/tree/master/packages/blake2s
 * Compatible with the Go crypto pkg
 */
public class Blake2s {
    ...
    public void update(byte[] data, int dataLength) throws Exception {
        if (finished) {
